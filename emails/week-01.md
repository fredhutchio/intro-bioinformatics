...
You will need three things before the first class.

* A laptop to bring to class
* A Fred Hutch account for server access. If you have a `fredhutch.org` email account you are good; you can test by logging in to [Centernet](https://centernet.fhcrc.org/CN/)). Please check and make sure that you can connect to the `Marconi` network
...
Finally, we've set up [a website](http://fredhutchio.github.io/intro-bioinformatics/) for the course, including links to slides and other resources.  Please come to the class with that website open, as it has a link to the slides we'll be using, which will be helpful for copying and pasting commands.
